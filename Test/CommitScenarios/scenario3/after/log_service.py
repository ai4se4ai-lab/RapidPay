...
# Chain A: Logging infrastructure - NOW connected to observability aggregator
...
class LogService:
    ...
    def log(self, level: LogLevel, message: str, 
        ...
        # Notify aggregator
        # FIXME: Aggregator notification is synchronous. If aggregator is slow,
        # it blocks logging. Should use async notification or queue.
        if self._aggregator_callback:
            try:
                self._aggregator_callback("log", entry)
            except Exception as e:
                print(f"LogService: Aggregator error: {e}")
